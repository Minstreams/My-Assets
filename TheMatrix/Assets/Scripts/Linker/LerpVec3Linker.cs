...
namespace GameSystem.Linker
{
    ...
    public class LerpVec3Linker : MonoBehaviour
    {
        ...
        [Label] public AnimationCurve remapXCurve = AnimationCurve.Linear(0, 0, 1, 1);
        [Label] public AnimationCurve remapYCurve = AnimationCurve.Linear(0, 0, 1, 1);
        [Label] public AnimationCurve remapZCurve = AnimationCurve.Linear(0, 0, 1, 1);
        [Label] public bool clamp = false;
