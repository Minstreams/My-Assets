...
namespace GameSystem.Operator
{
    ...
    public class CanvasMaterialFloatSetter : MonoBehaviour
    {
        ...
        [Label] public float target = 0.3f;
        [Label] public float time = 0.5f;
        [Label] public string paramName = "_EmissionFactor";

        [Label("Canvas Renderer")] public UnityEngine.UI.Image canvasRenderer;

        [Label(true)] public bool setOnStart = true;
        [Label(true)] public bool setOnEnable = false;
